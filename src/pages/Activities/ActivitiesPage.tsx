...
} from '@/features/activities/hooks/useActivitiesQuery';
...
export function ActivitiesPage() {
  ...
  const executeUpload = useCallback(
    async (
      ...
      if (uploadingRef.current.has(activity.id)) {
        return;
      }
  ...
  useEffect(() => {
    ...
    for (const activity of activitiesData.items) {
      const files =
        queuedFilesRef.current.get(activity.id);
  ...
  return (
    <div className="page-shell page-stack activities-page">
      {/* Hidden file input used by file-upload activities */}
      <input
        ref={fileInputRef}
        type="file"
        multiple
      ...
      <div className="page-header activities-header">
        <div>
          ...
          <p className="page-header-subtitle">
            ...
            carbon-aware digital workloads
            with full lifecycle status
            controls.
          </p>
        </div>
          ...
          ({ value, label }) => {
            ...
            return (
              ...
              >
                ...
                {count > 0 && (
                  <span
                    className={`ds-badge ml-0.5 px-1.5 py-0.5 ${
                      activeTab === value
