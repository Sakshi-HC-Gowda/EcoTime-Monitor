...
export function useCarbon(zone: string | null | undefined, offset: number = 0) {
  return useQuery({
...
export function useGreenWindows(zone: string | null | undefined, threshold: number = 180, offset: number = 0, enabled: boolean = true) {
  return useQuery({
